$.showprogress = function(progTit, progText, progImg)
{
    ...
    $("BODY").append(
      '<div id="processing_container">' +
       // '<h1 id="processing_title">' + progTit + '<a href="javascript:;" style="float:right" onclick="CloseWindow()"><img src="' + virtualDir + 'images/close2.gif"/></a></h1>' +
        '<div id="processing_content">' +
          //'<div id="processing_message">'+ progText + 
          '<div id="processing_message">Processing' + 
                      '<br/>' + progImg + '</div>' +
        '</div>' +
      '</div>');
