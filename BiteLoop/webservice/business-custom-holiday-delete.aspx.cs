...
public partial class webservice_Business_Custom_Holiday_Delete : System.Web.UI.Page
{
    #region Page Events
    ...
    private void DeleteBusinessHoliday()
    {
        ...
        else
        {
            ...
            objCommonBAL.BusinessCustomHolidayDelete_Webservice(Convert.ToInt64(Request["BusinessHolidayID"]), Convert.ToInt64(Request["BusinessID"]));
