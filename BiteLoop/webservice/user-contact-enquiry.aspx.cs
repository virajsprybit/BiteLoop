...
public partial class webservice_User_contact_enquiry : System.Web.UI.Page
{
    ...
    private void BusinessContactEnquiry()
    {
        ...
        {
            UserContactUsBAL objContactUsBAL = new UserContactUsBAL();
            objContactUsBAL.ID = 0;
            objContactUsBAL.BusinessID = Convert.ToInt64(Request["UserID"]);
            ...
            switch (result)
            {
                default:
                    ...
                    SendAdminMail(Convert.ToInt64(Request["UserID"]));
    ...
    private void SendAdminMail(long VendorID)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            GeneralSettings.SendEmail(new GeneralSettings().getConfigValue("infoemail"), new GeneralSettings().getConfigValue("infoemail"), strSubject.Replace("###WebsiteName###", Config.WebsiteName), sbEmailTemplate.ToString());
           // GeneralSettings.SendEmail("jane@bringmehome.com.au", new GeneralSettings().getConfigValue("infoemail"), strSubject.Replace("###WebsiteName###", Config.WebsiteName), sbEmailTemplate.ToString());
