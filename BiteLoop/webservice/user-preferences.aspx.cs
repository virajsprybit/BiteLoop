...
public partial class webservice_user_preferences : System.Web.UI.Page
{
    ...
    private void SaveUserPreferences()
    {
        try
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "SP_InsertOrUpdateUserPreferences", dbParam);
