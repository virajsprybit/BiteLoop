<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="Faq-List.aspx.cs" Inherits="AdminPanel_Faq_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHContent" runat="Server">
    ...
    <div class="panel">
        <div class="panel panel-default">
            ...
            <div class="panel-body panel-collapse collapse collapse" id="collapseThree">
                <form id="frmSearch" onsubmit="SubmitForm();return false;" action="Faq-list.aspx">
    ...
    <div class="panel">
        <div class="panel-heading">
            <div class="pull-left">
                <h4><i class="icon-table"></i>FAQ List</h4>
            </div>
                                    ...
                                    <asp:Repeater runat="server" ID="rptRecord">
                                        <ItemTemplate>
                                            <tr class="sequence" id='<%#((System.Data.DataRowView)Container.DataItem)["id"]%>'   name='<%#((System.Data.DataRowView)Container.DataItem)["ID"]%>'>
                                                ...
                                                <td><span class="text-primary"><strong><%#Common.FixLengthString(((System.Data.DataRowView)Container.DataItem)["Question"],150)%></strong></span> </td>
                                                <td class="actions">
        ...
        function SortTable() {
            ...
            $("#tblsortable tbody.content").sortable({
                ...
                update: function (event, ui) {
                    ...
                    if (PageUrl == 'faq-list.aspx?') {
                        PageUrl = 'faq-list.aspx';
                    }
                    $.ajax({
                        type: 'POST',
                        url: PageUrl + '?resequence=y&call=ajax',
                        data: { 'FAQID': ID, 'Seq': Seq },
                        success: function (response) {
                            $('#DivRender').html(response);
                            SortTable();
                            var sequence = 'FAQ sequence has been changed successfully.';
