...
public partial class AdminPanel_Notifications_Groups_List : AdminAuthentication
{
    private NotificationGroupBAL objNotificationsBAL = new NotificationGroupBAL();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            base.SortColumn = "NotificationGroup.ID";
        }
