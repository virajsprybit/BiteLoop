<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="Contactus-List.aspx.cs" Inherits="AdminPanel_Contactus_List" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHContent" runat="Server">
        ...
        <div class="pull-left">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="javascript:;" class="text-transparent" id="lnkSubmenu" runat="server">Vendor Contact Enquiry List</a></li>
            </ol>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel panel-default">
            ...
            <div class="panel-body panel-collapse collapse collapse" id="collapseThree">
                <form id="frmSearch" action="contactus-list.aspx" onsubmit="SubmitForm();$('#hrefExport').attr('href','contactus-list.aspx?ysnExport=1&txtName='+$('#txtName').val()+ '&txtEmail='+$('#txtEmail').val());return false;">
                ...
                <div class="panel-footer">
                    ...
                    <div class="pull-right"><a class="btn btn-info" id="hrefExport" href="contactus-list.aspx?ysnExport=1">Export Contact Us Enquiry</a></div>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="panel">
        <div class="panel-heading">
            <div class="pull-left">
                <h4><i class="icon-table"></i>Vendor Contact Enquiry List</h4>
            </div>
                                    ...
                                    <asp:Repeater runat="server" ID="rptRecord">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    <a class="external" data-toggle="modal" data-target='<%# "#myModal" +Eval("ID").ToString() %>' href="<%=Config.VirtualDir%>adminpanel/popupform.aspx?type=vendorenquiry&id=<%#((System.Data.DataRowView) Container.DataItem)["ID"] %>" title="Edit"><i class="icon-search"></i></a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHFooter" runat="Server">    
    ...
    <script type="text/javascript">
        ...
        var PageUrl = 'contactus-list.aspx';
        ...
        function Export() {
            window.location.href = 'contactus-list.aspx?ysnExport=1&txtEmail=' + $('#txtEmail').val();
        }
    </script>
</asp:Content>
