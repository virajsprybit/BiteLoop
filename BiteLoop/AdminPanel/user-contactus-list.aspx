<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="user-contactus-list.aspx.cs" Inherits="AdminPanel_UserContactus_List" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHContent" runat="Server">
        ...
        <div class="pull-left">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="javascript:;" class="text-transparent" id="lnkSubmenu" runat="server">User Contact Enquiry List</a></li>
            </ol>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel panel-default">
            ...
            <div class="panel-body panel-collapse collapse collapse" id="collapseThree">
                <form id="frmSearch" action="user-contactus-list.aspx" onsubmit="SubmitForm();$('#hrefExport').attr('href','user-contactus-list.aspx?ysnExport=1&txtName='+$('#txtName').val()+ '&txtEmail='+$('#txtEmail').val());return false;">
                    <div class="form-group hide">
                        <label for="txtName">Name</label>
                        <input type="text" class="form-control" name="txtName" id="txtName" maxlength="50" placeholder="Enter Company Name" />
                ...
                <div class="panel-footer">
                    ...
                    <div class="pull-right"><a class="btn btn-info" id="hrefExport" href="user-contactus-list.aspx?ysnExport=1">Export Contact Us Enquiry</a></div>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="panel">
        <div class="panel-heading">
            <div class="pull-left">
                <h4><i class="icon-table"></i>User Contact Enquiry List</h4>
            </div>
                                    ...
                                    <asp:Repeater runat="server" ID="rptRecord">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%# ((System.Data.DataRowView)Container.DataItem)["Phone"]%></td> 
                                                <td><%# ((System.Data.DataRowView)Container.DataItem)["Subject"]%></td> 
                                                <td><%#Convert.ToDateTime(((System.Data.DataRowView)Container.DataItem)["CreatedOn"]).ToString("dd/MM/yyyy")%></td>
                                                <td class="actions">
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHFooter" runat="Server">    
    ...
    <script type="text/javascript">
        ...
        var PageUrl = 'user-contactus-list.aspx';
        ...
        function Export() {
            window.location.href = 'user-contactus-list.aspx?ysnExport=1&txtEmail=' + $('#txtEmail').val();
        }
    </script>
</asp:Content>
