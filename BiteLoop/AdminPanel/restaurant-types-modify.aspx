<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="restaurant-types-modify.aspx.cs" Inherits="AdminPanel_RestaurantTypes_Modify" EnableEventValidation="false" ValidateRequest="false" %>
    ...
    <div class="row add-padding">
        <div class="pull-left">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="javascript:;" class="text-transparent" id="lnkSubmenu" runat="server">Restaurant Type Modify</a></li>
            </ol>
        </div>
    </div>
    <!-- row 2 -->
        ...
        <div class="col-lg-12">
            <div class="panel">
                <div class="panel-body well-lg">
                    <form id="frmRestaurantTypes" action="restaurant-types-modify.aspx?id=<%=ID%>" method="post" target="ifrmForm" enctype="multipart/form-data" onsubmit="return ValidateForm(this);">
                        ...
                        <div class="pull-right">
                            ...
                            <button type="button" class="btn btn-default" onclick="window.location='restaurant-types-list.aspx';">Cancel</button>
                        </div>
