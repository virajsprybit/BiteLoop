<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="profilephoto-modify.aspx.cs" Inherits="AdminPanel_profilephoto_Modify" EnableEventValidation="false" ValidateRequest="false" %>
    ...
    <div class="row add-padding">
        <div class="pull-left">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="javascript:;" class="text-transparent" id="lnkSubmenu" runat="server">Profile Photo Modify</a></li>
            </ol>
        </div>
    </div>
    <!-- row 2 -->
        ...
        <div class="col-lg-12">
            <div class="panel">
                <div class="panel-body well-lg">
                    <form id="frmprofilephoto" action="profilephoto-modify.aspx?id=<%=ID%>" method="post" target="ifrmForm" enctype="multipart/form-data" onsubmit="return ValidateForm(this);">
                        ...
                        <div class="form-group">
                            ...
                            <b>Note:</b>Image size approx.(750px Width x 421px Height) 
                            <br />
                            <b>Format :</b> .JPG, .JPEG, .PNG, .BMP, .GIF                                         
                        </div>
                        <div class="form-group">
                            <img id="imgImage" src="" alt="" runat="server" visible="false" />
                            <img src="<%=Config.VirtualDir %>adminpanel/images/delete.png" alt="Remove" id="imgprofilephoto" title="Remove" onclick="RemoveprofilephotoImage(this)" style="cursor: pointer; display: none;" />
                            <input type="hidden" runat="server" id="hdnprofilephotoFile" name="hdnprofilephotoFile" />
                        ...
                        <div class="pull-right">
                            ...
                            <button type="button" class="btn btn-default" onclick="window.location='profilephoto-list.aspx';">Cancel</button>
                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHFooter" runat="Server">
    <script type="text/javascript">
        ...
        function RemoveprofilephotoImage(imgprofilephoto) {
