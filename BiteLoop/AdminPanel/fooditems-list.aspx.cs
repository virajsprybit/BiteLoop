...
public partial class AdminPanel_FoodItems_List : AdminAuthentication
{
    ...
    private void BindList()
    {
        ...
        objFoodItemsBAL.Name = Title;
        dt = objFoodItemsBAL.GetList(ref CurrentPage, RecordPerPage, out TotalRecord, SortColumn, SortType);
    ...
    private void Operation()
    {
        ...
        {
            ObjFoodItemsBAL.FoodItemsOperation(Convert.ToString(Request["ID"]), ObjOpr);
            Response.Write(Javascript.DisplayMsg(divMsg.ClientID, strMsg, Javascript.MessageType.Success, true));
        }
        else
        {
            ObjFoodItemsBAL.FoodItemsOperation(Convert.ToString(Request["hdnID"]), ObjOpr);
