<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="sales-admin-list.aspx.cs" Inherits="AdminPanel_SalesAdmin_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHContent" Runat="Server">
        ...
        <div class="pull-left">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="javascript:;" class="text-transparent" id="lnkSubmenu" runat="server">Sales Admin List</a></li>
            </ol>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="pull-left"><h4><i class="icon-th-large"></i>Search</h4>
                </div> 
            ...
            <div class="panel-body panel-collapse collapse collapse" id="collapseThree">              
                <form  id="frmSearch" onsubmit="SubmitForm();return false;" action="sales-admin-list.aspx">
                    <div class="form-group">
                        <label for="tbxFname">Name</label>
                        <input type="text" class="form-control" id="tbxFname" name="tbxFname" maxlength="50" placeholder="Enter Name" />                          
                    </div>                     
                    <div class="form-group">
    ...
    <div class="panel">
        <div class="panel-heading">
            <div class="pull-left">
                <h4><i class="icon-table"></i>Sales Admin List</h4>
            </div>
             <div class="pull-right padding-right"><a class="btn btn-info" href="sales-admin-modify.aspx">Add New</a></div>
            <div class="clearfix"></div>
        </div>
            ...
            <div class="table-responsive">
                <div role="grid" class="dataTables_wrapper form-inline">
                    ...
                    <table class="dataTable table table-striped table-hover table-bordered custom-check">
                        <thead>
                            <tr>
                                <th class="check-header"><span class="check"><input class="checked" type="checkbox" onclick="CbxAll(this); GetSelRecord();" id="cbxAll" /></span></th>
                                <th>Full Name</th>
                                <th>Email Address</th>                                
                                 <th>Mobile</th>        
                        ...
                        <tbody>
                            <asp:Repeater runat="server" ID="rptRecord">
                                <ItemTemplate>
                                    <tr>
                                        <td class="check">
                                           <span class="check"> <input class="checked" type="checkbox" onclick="SetCbxBox(this);" id='chk<%# ((System.Data.DataRowView) Container.DataItem)["ID"] %>' name="<%# ((System.Data.DataRowView) Container.DataItem)["ID"] %>" /></span></td>
                                        ...
                                        <td class="actions">
                                            <a  href="sales-admin-modify.aspx?id=<%# ((System.Data.DataRowView) Container.DataItem)["ID"] %>" title="Edit"><i class="icon-pencil"></i></a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHFooter" Runat="Server">
    ...
    <script  type="text/javascript">
        ...
        var PageUrl = 'sales-admin-list.aspx';
        var FormName = 'frmSearch';
        var RspCtrl = 'DivRender';
        var divMsg = '<%= divMsg.ClientID %>';
        var SearchControl = 'tbxFname::FirstName@tbxUname::Username@tbxEmail::EmailId';
