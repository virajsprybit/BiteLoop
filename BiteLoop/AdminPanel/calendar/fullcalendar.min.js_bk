...
(function (t) {
    ...
    function E(t, e) {
        var n, i, r;
        for (n = 0; Ne.length > n && (i = Ne[n], r = C(i, t, e), !(r >= 1 && L(r))) ; n++);
        return i
    }
    ...
    function P(n, i, r) {
        ...
        return e.isMoment(d) ? (l = e.apply(null, n), O(d, l)) : D(d) || void 0 === d ? l = e.apply(null, n) : (s = !1, o = !1, u ? Ye.test(d) ? (d += "-01", n = [d], s = !0, o = !0) : (a = ze.exec(d)) && (s = !a[5], o = !0) : t.isArray(d) && (o = !0), l = i || s ? e.utc.apply(e, n) : e.apply(null, n), s ? (l._ambigTime = !0, l._ambigZone = !0) : r && (o ? l._ambigZone = !0 : u && l.zone(d))), l._fullCalendar = !0, l
    }
    ...
    function A(t, n) {
        var i, r, s = !1,
            ...
            a = t.length,
            l = [];
        for (i = 0; a > i; i++) r = t[i], e.isMoment(r) || (r = De.moment.parseZone(r)), s = s || r._ambigTime, o = o || r._ambigZone, l.push(r);
    ...
    function Z(t, e) {
        var n, i = "";
        for (n = 0; e.length > n; n++) i += j(t, e[n]);
        return i
    }

    function j(t, e) {
        var n, i;
        return "string" == typeof e ? e : (n = e.token) ? Pe[n] ? Pe[n](t) : W(t, n) : e.maybe && (i = Z(t, e.maybe), i.match(/[1-9]/)) ? i : ""
    }

    function X(t, e, n, i, r) {
        var s;
        return t = De.moment.parseZone(t), e = De.moment.parseZone(e), s = (t.localeData || t.lang).call(t), n = s.longDateFormat(n) || n, i = i || " - ", U(t, e, q(n), i, r)
    }
    ...
    function U(t, e, n, i, r) {
        var s, o, a, l, d = "",
            ...
            h = "",
            f = "";
        for (o = 0; n.length > o && (s = $(t, e, n[o]), s !== !1) ; o++) d += s;
    ...
    function $(t, e, n) {
        var i, r;
        return "string" == typeof n ? n : (i = n.token) && (r = Ae[i.charAt(0)], r && t.isSame(e, r)) ? W(t, i) : !1
    }

    function q(t) {
        return t in Oe ? Oe[t] : Oe[t] = K(t)
    }
    ...
    function ee(t) {
        return "inverse-background" === ne(t)
    }
    ...
    function oe(n) {
        var i, r, s, o, a = De.dataAttrPrefix;
    ...
    function de(t) {
        var e, n, i;
        if (t.sort(se), e = ue(t), ce(e), n = e[0]) {
            for (i = 0; n.length > i; i++) he(n[i]);
            for (i = 0; n.length > i; i++) fe(n[i], 0, 0)
        }
    }
    ...
    function ue(t) {
        ...
        for (e = 0; t.length > e; e++) {
            for (n = t[e], i = 0; r.length > i && ge(n, r[i]).length; i++);
    ...
    function ce(t) {
        ...
        for (e = 0; t.length > e; e++)
            for (n = t[e], i = 0; n.length > i; i++)
                for (r = n[i], r.forwardSegs = [], s = e + 1; t.length > s; s++) ge(r, t[s], r.forwardSegs)
    }
    ...
    function he(t) {
        ...
        if (void 0 === t.forwardPressure) {
            for (e = 0; i.length > e; e++) n = i[e], he(n), r = Math.max(r, 1 + n.forwardPressure);
            t.forwardPressure = r
        }
    }
    ...
    function fe(t, e, n) {
        ...
        if (void 0 === t.forwardCoord)
            for (r.length ? (r.sort(me), fe(r[0], e + 1, n), t.forwardCoord = r[0].backwardCoord) : t.forwardCoord = 1, t.backwardCoord = t.forwardCoord - (t.forwardCoord - n) / (e + 1), i = 0; r.length > i; i++) fe(r[i], 0, t.forwardCoord)
    }

    function ge(t, e, n) {
        n = n || [];
        for (var i = 0; e.length > i; i++) pe(t, e[i]) && n.push(e[i]);
        return n
    }
    ...
    function me(t, e) {
        return e.forwardPressure - t.forwardPressure || (t.backwardCoord || 0) - (e.backwardCoord || 0) || se(t, e)
    }
    ...
    function ve(n, r) {
        ...
        function l() {
            re = Q.theme ? "ui" : "fc", n.addClass("fc"), Q.isRTL ? n.addClass("fc-rtl") : n.addClass("fc-ltr"), Q.theme ? n.addClass("ui-widget") : n.addClass("fc-unthemed"), ie = t("<div class='fc-view-container'/>").prependTo(n), ee = new ye(q, Q), ne = ee.render(), ne && n.prepend(ne), c(Q.defaultView), Q.handleWindowResize && (ae = _(w, Q.windowResizeDelay), t(window).resize(ae))
        }

        function d() {
            se && se.destroyView(), ee.destroy(), ie.remove(), n.removeClass("fc fc-ltr fc-rtl fc-unthemed ui-widget"), t(window).unbind("resize", ae)
        }
        ...
        function f(n) {
            ...
            var r, s, a, l, d, u = Q.defaultButtonText || {},
                ...
                p = !1;
            if (he[n]) return he[n];
            for (; f && !s;) r = {}, i(Te[f]), i(h[f]), g.unshift(r), f = r.type;
            return g.unshift({}), r = t.extend.apply(t, g), s ? (a = r.duration || s.duration, a && (a = e.duration(a), l = E(a), p = 1 === a.as(l)), p && h[l] && (r = t.extend({}, h[l], r)), d = c[n] || (p ? c[l] : null) || u[n] || (p ? u[l] : null) || r.buttonText || s.buttonText || (a ? o(a) : null) || n, he[n] = {
                "class": s,
                options: r,
                buttonText: d
            }) : void 0
        ...
        function m(t) {
            return u() ? (t && y(), fe++, se.updateSize(!0), fe--, !0) : void 0
        }
        ...
        function S() {
            u() && (I(), se.destroyViewEvents(), se.renderViewEvents(ge), Z())
        }

        function C() {
            I(), se.destroyViewEvents(), Z()
        }

        function D() {
            !Q.lazyFetching || de(se.start, se.end) ? T() : S()
        }
        ...
        function N() {
            le = se.computePrevDate(le), c()
        }

        function V() {
            le = se.computeNextDate(le), c()
        }
        ...
        function O(t) {
            le.add(e.duration(t)), c()
        }

        function B(t, e) {
            var n, i;
            e && g(e) || (e = e || "day", n = ee.getViewsWithButtons().join(" "), i = n.match(RegExp("\\w+" + Y(e))), i || (i = n.match(/\w+Day/)), e = i ? i[0] : "agendaDay"), le = t, c(e)
        }
        ...
        r = r || {};
        var K, Q = i({}, Se, r);
        K = Q.lang in ke ? ke[Q.lang] : ke[Se.lang], K && (Q = i({}, Se, K, r)), Q.isRTL && (Q = i({}, Se, Ce, K || {}, r)), q.options = Q, q.render = a, q.destroy = d, q.refetchEvents = b, q.reportEvents = H, q.reportEventChange = x, q.rerenderEvents = S, q.changeView = c, q.select = F, q.unselect = G, q.prev = N, q.next = V, q.prevYear = z, q.nextYear = L, q.today = P, q.gotoDate = A, q.incrementDate = O, q.zoomTo = B, q.getDate = W, q.getCalendar = j, q.getView = X, q.option = U, q.trigger = $, q.isValidViewType = g, q.getViewButtonText = p;
        var J = k(s(Q.lang));
        ...
        var ee, ne, ie, re, se, oe, ae, le, de = q.isFetchNeeded,
            ue = q.fetchEvents,
            ce = n[0],
            he = {},
            fe = 0,
            ge = [];
        le = null != Q.defaultDate ? q.moment(Q.defaultDate) : q.getNow(), q.getSuggestedViewHeight = function () {
        ...
        function s(i) {
            ...
            return s && t.each(s.split(" "), function () {
                ...
                t.each(this.split(","), function (i, r) {
                    var a, l, d, u, c, h, g, m, v;
                    "title" == r ? (s = s.add(t("<h2>&nbsp;</h2>")), o = !1) : (e[r] ? a = function () {
                        e[r]()
                    } : e.isValidViewType(r) && (a = function () {
                        e.changeView(r)
    ...
    function we(n) {
        ...
        function s(e, n) {
            o(e, function (i) {
                ...
                if (n == $) {
                    if (i)
                        for (r = 0; i.length > r; r++) s = i[r], o = a ? s : E(s, e), o && Q.push.apply(Q, H(o));
                    q--, q || j(Q)
                }
            })
        }
        ...
        function o(e, i) {
            ...
            if (l) t.isFunction(l) ? (y(), l.call(O, B.clone(), W.clone(), n.timezone, function (t) {
                ...
                if (d) {
                    ...
                    p && (g[p] = B.format()), m && (g[m] = W.format()), n.timezone && "local" != n.timezone && (g[v] = n.timezone), y(), t.ajax(t.extend({}, Qe, e, {
                        data: g,
                        success: function (e) {
                            e = e || [];
        ...
        function h(t) {
            t.start = O.moment(t.start), t.end = t.end ? O.moment(t.end) : null, x(t, f(t)), j(Q)
        }

        function f(e) {
            var n = {};
            return t.each(e, function (t, e) {
                g(t) && void 0 !== e && R(e) && (n[t] = e)
            }), n
        }
        ...
        function m(e) {
            ...
            for (null == e ? e = function () {
                    ...
                    return t._id == n
            }), Q = t.grep(Q, e, !0), i = 0; U.length > i; i++) t.isArray(U[i].events) && (U[i].events = t.grep(U[i].events, e, !0));
            j(Q)
        }
        ...
        function C(t, e, n, i) {
            i.start = t, i.end = e, i.allDay = n, D(i), be(i)
        }
        ...
        function M(e, n, i, r, s, o) {
            ...
            return r && !r.valueOf() && (r = null), s && !s.valueOf() && (s = null), t.each(e, function (e, d) {
                ...
                u = {
                    ...
                    allDay: d._allDay
                }, n && (c.end = null), c.allDay = i, D(c), r && (c.start.add(r), c.end && c.end.add(r)), s && (c.end || (c.end = O.getDefaultEventEnd(c.allDay, c.start)), c.end.add(s)), a && !c.allDay && (r || s) && (c.start.stripZone(), c.end && c.end.stripZone()), t.extend(d, o, c), be(d), l.push(function () {
                    t.extend(d, u), be(d)
                })
            }),
                function () {
        ...
        function L(t, e, n, i) {
            ...
            if (t = {
                ...
                for (r = _(e), s = !1, o = 0; r.length > o; o++)
                    if (P(r[o], t)) {
                        s = !0;
                        break
                    }
    ...
    t.fn.fullCalendar = function (e) {
        ...
        return this.each(function (r, s) {
            ...
            "string" == typeof e ? l && t.isFunction(l[e]) && (o = l[e].apply(l, n), r || (i = o), "destroy" === e && a.removeData("fullCalendar")) : l || (l = new ve(a, e), a.data("fullCalendar", l), l.render())
        }), i
    };
    var ke = De.langs = {};
    De.datepickerLang = function (e, n, i) {
        ...
        var r, o;
        r = ke[e] || (ke[e] = {}), n && i(r, n), o = s(e), t.each(xe, function (t, e) {
    ...
    De.lang("en", Ee), De.intersectionToSeg = y, De.applyAll = F, De.debounce = _;
    var Me, Re, Fe, Ge = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"],
        Ne = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"],
        Ve = {}.hasOwnProperty,
        Ye = /^\s*\d{4}-\d\d$/,
    ...
    De.moment = function () {
        ...
        var t = _e.clone.apply(this, arguments);
        return O(this, t), this._fullCalendar && (t._fullCalendar = !0), t
    }, Le.time = function (t) {
        if (!this._fullCalendar) return _e.time.apply(this, arguments);
    ...
    }, Le.stripTime = function () {
        var t;
        return this._ambigTime || (t = this.toArray(), this.utc(), Re(this, t.slice(0, 3)), this._ambigTime = !0, this._ambigZone = !0), this
    }, Le.hasTime = function () {
        return !this._ambigTime
    }, Le.stripZone = function () {
        var t, e;
        return this._ambigZone || (t = this.toArray(), e = this._ambigTime, this.utc(), Re(this, t), this._ambigTime = e || !1, this._ambigZone = !0), this
    }, Le.hasZone = function () {
        return !this._ambigZone
    }, Le.local = function () {
        var t = this.toArray(),
            e = this._ambigZone;
        return _e.local.apply(this, arguments), this._ambigTime = !1, this._ambigZone = !1, e && Fe(this, t), this
    }, Le.utc = function () {
        return _e.utc.apply(this, arguments), this._ambigTime = !1, this._ambigZone = !1, this
    }, t.each(["zone", "utcOffset"], function (t, e) {
        _e[e] && (Le[e] = function (t) {
            return null != t && (this._ambigTime = !1, this._ambigZone = !1), _e[e].apply(this, arguments)
        })
    }), Le.format = function () {
        return this._fullCalendar && arguments[0] ? I(this, arguments[0]) : this._ambigTime ? W(this, "YYYY-MM-DD") : this._ambigZone ? W(this, "YYYY-MM-DD[T]HH:mm:ss") : _e.format.apply(this, arguments)
    }, Le.toISOString = function () {
        return this._ambigTime ? W(this, "YYYY-MM-DD") : this._ambigZone ? W(this, "YYYY-MM-DD[T]HH:mm:ss") : _e.toISOString.apply(this, arguments)
    }, Le.isWithin = function (t, e) {
        var n = A([this, t, e]);
        return n[0] >= n[1] && n[0] < n[2]
    }, Le.isSame = function (t, e) {
        var n;
        return this._fullCalendar ? e ? (n = A([this, t], !0), _e.isSame.call(n[0], n[1], e)) : (t = De.moment.parseZone(t), _e.isSame.call(this, t) && Boolean(this._ambigTime) === Boolean(t._ambigTime) && Boolean(this._ambigZone) === Boolean(t._ambigZone)) : _e.isSame.apply(this, arguments)
    }, t.each(["isBefore", "isAfter"], function (t, e) {
        Le[e] = function (t, n) {
            var i;
            return this._fullCalendar ? (i = A([this, t]), _e[e].call(i[0], i[1], n)) : _e[e].apply(this, arguments)
        }
    }), Me = "_d" in e() && "updateOffset" in e, Re = Me ? function (t, n) {
        t._d.setTime(Date.UTC.apply(Date, n)), e.updateOffset(t, !1)
    } : B, Fe = Me ? function (t, n) {
    ...
    var Ae = {
        ...
        Oe = {};
    De.Class = Q, Q.extend = function (t) {
        var e, n = this;
        return t = t || {}, M(t, "constructor") && (e = t.constructor), "function" != typeof e && (e = t.constructor = function () {
    ...
    var Be = Q.extend({
        ...
        We = Q.extend({
            ...
            getCell: function (e, n) {
                ...
                for (i = 0; s.length > i; i++)
                    if (r = s[i], n >= r.top && r.bottom > n) {
                        a = i;
                        break
                    }
                for (i = 0; o.length > i; i++)
                    if (r = o[i], e >= r.left && r.right > e) {
                        l = i;
                        break
                    }
        ...
        Ze = Q.extend({
            ...
            dragScroll: function (t) {
                var e, n, i, r, s = this.scrollSensitivity,
                    ...
                    a = 0,
                    l = 0;
                o && (e = (s - (t.pageY - o.top)) / s, n = (s - (o.bottom - t.pageY)) / s, i = (s - (t.pageX - o.left)) / s, r = (s - (o.right - t.pageX)) / s, e >= 0 && 1 >= e ? a = -1 * e * this.scrollSpeed : n >= 0 && 1 >= n && (a = n * this.scrollSpeed), i >= 0 && 1 >= i ? l = -1 * i * this.scrollSpeed : r >= 0 && 1 >= r && (l = r * this.scrollSpeed)), this.setScrollVel(a, l)
            },
        ...
        Ue = De.Grid = Xe.extend({
            ...
            constructor: function () {
                Xe.apply(this, arguments), this.coordMap = new We(this), this.elsByFill = {}, this.documentDragStartProxy = t.proxy(this, "documentDragStart")
            },
            render: function () {
                this.bindHandlers()
            },
            ...
            headCellHtml: function (t) {
                var e = this.view,
                    n = t.start;
                return '<th class="fc-day-header ' + e.widgetHeaderClass + " fc-" + Ge[n.day()] + '">' + N(n.format(this.colHeadFormat)) + "</th>"
            },
    ...
    Ue.mixin({
        ...
        renderEvents: function (t) {
            var e, n, i = this.eventsToSegs(t),
                r = [],
                s = [];
            for (e = 0; i.length > e; e++) n = i[e], te(n.event) ? r.push(n) : s.push(n);
        ...
        startExternalDrag: function (e, n) {
            var i, r, s = this,
                o = oe(e);
            i = new Ze(this.coordMap, {
                cellOver: function (t) {
                    r = s.computeExternalDrop(t, o), r ? s.renderDrag(r) : l()
                },
                cellOut: function () {
                    r = null, s.destroyDrag(), d()
                }
            }), t(document).one("dragstop", function (t, n) {
                s.destroyDrag(), d(), r && s.view.reportExternalDrop(o, r, e, t, n)
            }), i.startDrag(n)
        },
        ...
        eventsToRanges: function (e) {
            ...
            return t.each(i, function (t, e) {
                e.length && r.push.apply(r, ee(e[0]) ? n.eventsToInverseRanges(e) : n.eventsToNormalRanges(e))
            }), r
        },
        ...
        eventsToInverseRanges: function (t) {
            var e, n, i = this.view,
                ...
                l = t[0],
                d = r;
            for (o.sort(re), e = 0; o.length > e; e++) n = o[e], n.start > d && a.push({
                event: l,
                start: d,
                end: n.start
            }), d = n.end;
    ...
    }), De.compareSegs = se, De.dataAttrPrefix = "";
    var $e = Ue.extend({
        numbersVisible: !1,
        ...
        render: function (t) {
            ...
            Ue.prototype.render.call(this)
        },
        destroy: function () {
            this.destroySegPopover(), Ue.prototype.destroy.call(this)
        },
        ...
        computeRowCoords: function () {
            var t = Ue.prototype.computeRowCoords.call(this);
    ...
    $e.mixin({
        rowStructs: null,
        destroyEvents: function () {
            this.destroySegPopover(), Ue.prototype.destroyEvents.apply(this, arguments)
        },
        getEventSegs: function () {
        ...
        renderBgSegs: function (e) {
            ...
            return Ue.prototype.renderBgSegs.call(this, n)
        },
        renderFgSegs: function (e) {
            var n;
            return e = this.renderFgSegEls(e), n = this.rowStructs = this.renderSegRows(e), this.rowEls.each(function (e, i) {
                n.length > e && t(i).find(".fc-content-skeleton > table").append(n[e].tbodyEl)
            }), e
        },
        destroyFgSegs: function () {
        ...
        fgSegHtml: function (t, e) {
            var n, i = this.view,
                ...
                d = "";
            return a.unshift("fc-day-grid-event"), !r.allDay && t.isStart && (d = '<span class="fc-time">' + N(this.getEventTimeText(r)) + "</span>"), n = '<span class="fc-title" title=' + (N(r.title || "") || "&nbsp;") + '>' + (N(r.title || "") || "&nbsp;") + "</span>", '<a class="' + a.join(" ") + '"' + (r.url ? ' href="' + N(r.url) + '"' : "") + (l ? ' style="' + l + '"' : "") + ">" + '<div class="fc-content">' + (this.isRTL ? n + " " + d : d + " " + n) + "</div>" + (o ? '<div class="fc-resizer"/>' : "") + "</a>"
        },
            ...
            for (r = 0; f > r; r++) {
                if (s = h[r], o = 0, a = t("<tr/>"), p.push([]), m.push([]), v.push([]), s)
                    for (l = 0; s.length > l; l++) {
                        for (d = s[l], i(d.leftCol), u = t('<td class="fc-event-container"/>').append(d.el), d.leftCol != d.rightCol ? u.attr("colspan", d.rightCol - d.leftCol + 1) : v[r][o] = u; d.rightCol >= o;) m[r][o] = u, p[r][o] = d, o++;
                        a.append(u)
                    }
        ...
        buildSegLevels: function (t) {
            var e, n, i, r = [];
            for (t.sort(se), e = 0; t.length > e; e++) {
                for (n = t[e], i = 0; r.length > i && ae(n, r[i]) ; i++);
                n.level = i, (r[i] || (r[i] = [])).push(n)
            }
        ...
        limitRow: function (e, n) {
            ...
            if (n && S.segLevels.length > n) {
                for (s = S.segLevels[n - 1], o = S.cellMatrix, a = S.tbodyEl.children().slice(n).addClass("fc-limited").get(), l = 0; s.length > l; l++) {
                    for (d = s[l], i(d.leftCol), h = [], c = 0; d.rightCol >= C;) r = this.getCell(e, C), u = this.getCellSegs(r, n), h.push(u), c += u.length, C++;
                    if (c) {
                        for (f = o[n - 1][d.leftCol], g = f.attr("rowspan") || 1, p = [], m = 0; h.length > m; m++) v = t('<td class="fc-more-cell"/>').attr("rowspan", g), u = h[m], r = this.getCell(e, d.leftCol + m), w = this.renderMoreLink(r, [d].concat(u)), y = t("<div/>").append(w), v.append(y), p.push(v[0]), E.push(v[0]);
        ...
        showSegPopover: function (t, e, n) {
            ...
            }, this.isRTL ? r.right = a.offset().left + a.outerWidth() + 1 : r.left = a.offset().left - 1, this.segPopover = new Be(r), this.segPopover.show()
        },
    ...
    var qe = Ue.extend({
        ...
        render: function () {
            this.el.html(this.renderHtml()), this.dayEls = this.el.find(".fc-day"), this.slatEls = this.el.find(".fc-slats tr"), this.computeSlatTops(), this.renderBusinessHours(), Ue.prototype.render.call(this)
        },
        ...
        renderHelper: function (e, n) {
            ...
            for (a = this.renderFgSegEls(a), i = this.renderSegTable(a), r = 0; a.length > r; r++) s = a[r], n && n.col === s.col && (o = n.el, s.el.css({
                left: o.css("left"),
                right: o.css("right"),
        ...
        renderFill: function (e, n, i) {
            var r, s, o, a, l, d, u, c, h, f;
            if (n.length) {
                for (n = this.renderFillSegEls(e, n), r = this.groupSegCols(n), i = i || e.toLowerCase(), s = t('<div class="fc-' + i + '-skeleton">' + "<table><tr/></table>" + "</div>"), o = s.find("tr"), a = 0; r.length > a; a++)
                    if (l = r[a], d = t("<td/>").appendTo(o), l.length)
                        for (u = t('<div class="fc-' + i + '-container"/>').appendTo(d), c = this.colData[a].day, h = 0; l.length > h; h++) f = l[h], u.append(f.el.css({
    ...
    qe.mixin({
        ...
        renderSegTable: function (e) {
            ...
            for (n = this.groupSegCols(e), this.computeSegVerticals(e), s = 0; n.length > s; s++) {
                for (o = n[s], de(o), a = t('<div class="fc-event-container"/>'), i = 0; o.length > i; i++) r = o[i], r.el.css(this.generateSegPositionCss(r)), 30 > r.bottom - r.top && r.el.addClass("fc-short"), a.append(r.el);
    ...
    var Qe = {
        ...
        tn = Te.basic = Ke.extend({
            ...
            setRange: function (t) {
                Ke.prototype.setRange.call(this, t), this.dayGrid.breakOnWeeks = /year|month|week/.test(this.intervalUnit), this.dayGrid.setRange(t)
            },
            computeRange: function (t) {
                var e = Ke.prototype.computeRange.call(this, t);
            ...
            destroy: function () {
                this.dayGrid.destroy(), Ke.prototype.destroy.call(this)
            },
            renderHtml: function () {
    ...
    var en = Te.month = tn.extend({
        computeRange: function (t) {
            var e, n = tn.prototype.computeRange.call(this, t);
    ...
    Te.agenda = Ke.extend({
        ...
        initialize: function () {
            this.timeGrid = new qe(this), this.opt("allDaySlot") ? (this.dayGrid = new $e(this), this.coordMap = new Ie([this.dayGrid.coordMap, this.timeGrid.coordMap])) : this.coordMap = this.timeGrid.coordMap
        },
        setRange: function (t) {
            Ke.prototype.setRange.call(this, t), this.timeGrid.setRange(t), this.dayGrid && this.dayGrid.setRange(t)
        },
        render: function () {
            this.el.addClass("fc-agenda-view").html(this.renderHtml()), this.scrollerEl = this.el.find(".fc-time-grid-container"), this.timeGrid.coordMap.containerEl = this.scrollerEl, this.timeGrid.el = this.el.find(".fc-time-grid"), this.timeGrid.render(), this.bottomRuleEl = t('<hr class="' + this.widgetHeaderClass + '"/>').appendTo(this.timeGrid.el), this.dayGrid && (this.dayGrid.el = this.el.find(".fc-day-grid"), this.dayGrid.render(), this.dayGrid.bottomCoordPadding = this.dayGrid.el.next("hr").outerHeight()), this.noScrollRowEls = this.el.find(".fc-row:not(.fc-scroller *)")
        },
        destroy: function () {
            this.timeGrid.destroy(), this.dayGrid && this.dayGrid.destroy(), Ke.prototype.destroy.call(this)
        },
        renderHtml: function () {
        ...
        updateSize: function (t) {
            t && this.timeGrid.resize(), Ke.prototype.updateSize.call(this, t)
        },
        updateWidth: function () {
        ...
        rowsForMonth: [],
        initialize: function () {
            this.updateOptions(), this.dayGrid = new $e(this), this.dayGrids[0] = this.dayGrid, this.coordMap = this.dayGrid.coordMap
        },
        ...
        render: function () {
            var t = Math.floor(this.intervalStart.month() / this.nbMonths) * this.nbMonths;
            !t && this.firstMonth > 0 && !this.opt("lastMonth") && (t = (this.firstMonth + t) % 12), this.intervalStart = De.moment([this.intervalStart.year(), t, 1]), this.intervalEnd = this.intervalStart.clone().add(this.nbMonths, "months").add(-15, "minutes"), this.start = this.intervalStart.clone(), this.start = this.skipHiddenDays(this.start), this.start.startOf("week"), this.start = this.skipHiddenDays(this.start), this.end = this.intervalEnd.clone(), this.end = this.skipHiddenDays(this.end, -1, !0), this.end.add((7 - this.end.weekday()) % 7, "days"), this.end = this.skipHiddenDays(this.end, -1, !0);
            var e = parseInt(this.opt("yearColumns"), 10),
                n = this.opt("weekends") ? 7 : 5;
            this.renderYear(e, n, !0)
        },
        ...
        setRange: function (t) {
            Ke.prototype.setRange.call(this, t)
        },
        computeRange: function (t) {
        ...
        buildSkeleton: function (e) {
            var n, i, r, s, o = 0,
                a = 0,
                l = this.intervalStart.year(),
                d = this.tm + "-widget-header",
                u = [];
            for (this.rowCnt = 0, i = 0; 7 > i; i++) u[i] = De.moment([2013, 11, 1 + i]).locale(this.lang).format("ddd");
            for (s = '<table class="fc-year-main-table fc-border-separate" style="width:100%;"><tr>', s += '<td class="fc-year-month-border fc-first"></td>', i = 0; this.nbMonths > i; i++) {
                var c = this.intervalStart.month() + i,
                    h = -1 != t.inArray(c % 12, this.hiddenMonths),
                    f = h ? "display:none;" : "",
                    g = De.moment([l + c / 12, c % 12, 1]).locale(this.lang),
                    p = Y(g.format("MMMM")),
                    m = g.format("YYYYMM");
                for (r = g.year(), this.firstMonth + this.nbMonths > 12 && (p = p + " " + r), 0 === i % e && i > 0 && !h && (a++, s += '<td class="fc-year-month-border fc-last"></td></tr><tr><td class="fc-year-month-border fc-first"></td>'), e > i % e && i % e > 0 && !h && (s += '<td class="fc-year-month-separator"></td>'), s += '<td class="fc-year-monthly-td" style="' + f + '">', s += '<div class="fc-year-monthly-name' + (0 === a ? " fc-first" : "") + '">' + '<a name="' + m + '" data-year="' + r + '" data-month="' + c + '" href="#">' + N(p) + "</a>" + "</div>", s += '<div class="fc-row ' + d + '">', s += '<table class="fc-year-month-header"><thead><tr class="fc-year-week-days">', s += this.headIntroHtml(), n = this.firstDay; this.colCnt + this.firstDay > n; n++) s += '<th class="fc-day-header fc-year-weekly-head fc-' + Ge[n % 7] + " " + d + '">' + u[n % 7] + "</th>";
                s += "</tr><tr></tr></thead></table>", s += "</div>", s += '<div class="fc-day-grid-container"><div class="fc-day-grid">', s += "</div></div>", s += '<div class="fc-year-monthly-footer"></div>', s += "</td>", h && o++
            }
            s += '<td class="fc-year-month-border fc-last"></td>', s += "</tr></table>", this.table = t(s).appendTo(this.el), this.bodyRows = this.table.find(".fc-day-grid .fc-week"), this.bodyCells = this.bodyRows.find("td.fc-day"), this.bodyFirstCells = this.bodyCells.filter(":first-child"), this.subTables = this.table.find("td.fc-year-monthly-td"), this.head = this.table.find("thead"), this.head.find("tr.fc-year-week-days th.fc-year-weekly-head:first").addClass("fc-first"), this.head.find("tr.fc-year-week-days th.fc-year-weekly-head:last").addClass("fc-last"), this.table.find(".fc-year-monthly-name a").click(this.calendar, function (e) {
        ...
        buildDayGrids: function () {
            for (var e = this, n = [], i = 0; this.nbMonths > i; i++) n.push(i + this.intervalStart.month());
            var r = e.intervalStart.clone().add(7, "days");
            e.dayGrids = [], t.each(n, function (t) {
                var n = new $e(e),
                    i = e.tableByOffset(t),
                    s = r.clone().add(t, "months");
                ...
                var o = e.computeMonthRange(s);
                n.start = o.start, n.end = o.end, n.breakOnWeeks = !0, n.updateCells(), e.dayNumbersVisible = n.rowCnt > 1, n.numbersVisible = e.dayNumbersVisible || e.weekNumbersVisible, $e.prototype.render.call(n, e.hasRigidRows()), e.dayGrids.push(n)
        ...
        computeMonthRange: function (t) {
            ...
            var e = Ke.prototype.computeRange.call(this, t);
            if (/year|month/.test(e.intervalUnit)) {
                e.start.startOf("week"), e.start = this.skipHiddenDays(e.start), e.end.weekday() && (e.end.add(1, "week").startOf("week"), e.end = this.skipHiddenDays(e.end, -1, !0));
                var n = Math.ceil(e.end.diff(e.start, "weeks", !0));
                5 === this.isFixedWeeks() ? 4 == n && e.end.add(1, "weeks") : this.isFixedWeeks() && 6 >= n && e.end.add(6 - n, "weeks")
            }
            return e
        },
        destroy: function () {
            t.each(this.dayGrids, function (t, e) {
                e.destroy()
            }), Ke.prototype.destroy.call(this)
        },
        updateCells: function () {
            var e = this;
            this.subTables.find(".fc-week:first").addClass("fc-first"), this.subTables.find(".fc-week:last").addClass("fc-last"), this.subTables.find(".fc-bg").find("td.fc-day:last").addClass("fc-last"), this.subTables.each(function (n, i) {
                e.curYear || (e.curYear = e.intervalStart);
                var r = e.curYear.clone(),
                    s = (n + e.intervalStart.month()) % 12;
                r = e.dayGrids[n].start;
                var o = 0;
                t(i).find(".fc-bg").find("td.fc-day:first").addClass("fc-first"), e.otherMonthDays[s] = [0, 0, 0, 0], t(i).find(".fc-content-skeleton tr").each(function (i, a) {
                    0 === i && e.dateInMonth(r, s) && (e.otherMonthDays[s][2] = r.date() - 1), t(a).find("td").not(".fc-week-number").each(function (a, l) {
                        var d = t(l);
                        r = e.dayGrids[n].cellDates[a + i * e.colCnt], e.dateInMonth(r, s) ? o = r : (d.addClass("fc-other-month"), r.month() == (s + 11) % 12 ? (e.otherMonthDays[s][0]++, d.addClass("fc-prev-month")) : (e.otherMonthDays[s][1]++, d.addClass("fc-next-month")))
                    })
                });
                var a = e.daysInMonth(e.curYear.year(), s + 1) - o;
                e.otherMonthDays[s][3] = a
            }), e.bodyRows.filter(".fc-year-have-event").removeClass("fc-year-have-event")
        },
        headIntroHtml: function () {
            return this.weekNumbersVisible ? '<th class="fc-week-number-head ' + this.widgetHeaderClass + '">' + "<span>" + N(this.opt("weekNumberTitle")) + "</span>" + "</th>" : ""
        },
        numberIntroHtml: function (t, e) {
            return this.weekNumbersVisible ? (e = e || this.dayGrid, '<td class="fc-week-number" ' + this.weekNumberStyleAttr("") + ">" + "<span>" + this.calendar.calculateWeekNumber(e.getCell(t, 0).start) + "</span>" + "</td>") : ""
        },
        dayIntroHtml: function () {
        ...
        daysInMonth: function (t, e) {
            return De.moment([t, e, 0]).date()
        },
        dateInMonth: function (t, e) {
            return t.month() == e % 12
        },
        rowToGridOffset: function (t) {
            for (var e = 0, n = this.firstMonth; this.lastMonth > n; n++)
        ...
        setGridHeight: function (e, n, i) {
            return i !== void 0 ? (n ? c(i.rowEls) : u(i.rowEls, e, !0), void 0) : (t.each(this.dayGrids, function (t, i) {
        ...
        dayClick: function (e) {
            if (!this.opt("selectable")) {
                ...
                t.trigger("dayClick", this, De.moment(i), !0, e)
            }
        },
        ...
        getEventSegs: function () {
            ...
            return t.each(this.dayGrids, function (t, n) {
                for (var i = n.getEventSegs(), r = 0; i.length > r; r++) e.push(i[r])
            }), e
        },
        destroyEvents: function () {
