<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="contactus-subject-list.aspx.cs" Inherits="AdminPanel_ContactUsSubject_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHContent" runat="Server">
    <div class="row add-padding">
        <div class="pull-left">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="javascript:;" class="text-transparent" id="lnkSubmenu" runat="server">Contact Us Subject List</a></li>
            </ol>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel panel-default">
            ...
            <div class="panel-body panel-collapse collapse collapse" id="collapseThree">
                <form id="frmSearch" onsubmit="SubmitForm();return false;" action="contactus-subject-list.aspx">
    ...
    <div class="panel">
        <div class="panel-heading">
            <div class="pull-left">
                <h4><i class="icon-table"></i>Contact Us Subject List</h4>
            </div>
            <div class="pull-right padding-right"><a class="btn btn-info" href="contactus-subject-modify.aspx">Add New</a></div>
            <div class="clearfix"></div>
        </div>
                                    ...
                                    <asp:Repeater runat="server" ID="rptRecord">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    <a href="contactus-subject-modify.aspx?id=<%# ((System.Data.DataRowView) Container.DataItem)["ID"] %>" title="Edit"><i class="icon-pencil"></i></a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHFooter" runat="Server">
    <script type="text/javascript">
        ...
        var PageUrl = 'contactus-subject-list.aspx';
