<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mealpopupform.aspx.cs" Inherits="controlpanel_MelasPopupform" %>
...
<body>
                ...
                <asp:Repeater ID="rptContactUs" runat="server" Visible="false">
                    <ItemTemplate>
                        ...
                        <table class="tblRewards">
                            <tr>
                                <td>
                                    <input type="text" class="form-control discount txtRewards" id="txtRewards" name="txtRewards" maxlength="10" style="border: 1px solid #bdbdbd !important" value='<%#Convert.ToString(Eval("TotalMeals")).Replace(".00","") %>' /></td>
                                <td>
    ...
    <script type="text/javascript">
        ...
        function UpdateRewards(id) {           
            ...
            $.ajax({
                url: 'mealpopupform.aspx?updatemeals=y',
                type: 'POST',
                data: { 'id': id, 'meals': jQuery.trim($('.txtRewards').val()) },
                success: function (resp) {
                    DisplMsg(divRewards, 'Total Meals has been updated successfully.', 'alert-message success');
                    setTimeout('HidePopup();', '3000');
                    $('.meals' + id).text(jQuery.trim($('.txtRewards').val()));
                }
            });
        }
