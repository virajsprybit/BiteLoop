<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rewardspopupform.aspx.cs" Inherits="controlpanel_Rewardspopupform" %>
                ...
                <asp:Repeater ID="rptContactUs" runat="server" Visible="false">
                    <ItemTemplate>
                        ...
                        <table class="tblRewards">
                            <tr>
                                <td>
                                    <input type="text" class="form-control discount txtRewards" id="txtRewards" name="txtRewards" maxlength="10" style="border: 1px solid #bdbdbd !important" value='<%#Convert.ToString(Eval("RewardsPoints")).Replace(".00","") %>' /></td>
                                <td>
