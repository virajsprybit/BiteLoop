...
public partial class AdminPanel_Testimonial_Modify : AdminAuthentication
{
    ...
    private void SaveInfo()
    {
        if (Request.Files[fupdImage.UniqueID] != null)
        {
            if (Request.Files[fupdImage.UniqueID].ContentLength > 0)
            {
                ...
                if (ID != 0)
                {
                    DeleteTestimonialsFile(Convert.ToString(Request[hdnTestimonialsFile.UniqueID]));
                }
        ...
        objTestimonialsBAL.ImageName = strImageName;
        objTestimonialsBAL.ID = ID;
        ...
        switch (intResult)
        {
            ...
            default:
                ...
                Response.Write(Common.ScriptStartTag + "parent.ScrollTop();" + Common.ScriptEndTag);
                Response.Write(Common.ScriptStartTag + "parent.window.setTimeout(\"parent.window.location.href = 'testimonials-list.aspx'\",1000);" + Common.ScriptEndTag);
                break;
        }
        Response.End();
