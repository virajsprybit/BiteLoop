...
public partial class AdminPanel_testimonials_List : AdminAuthentication
{
    #region Private Members
    private new string Title = string.Empty;
    #endregion

    TestimonialsBAL objTestimonialsBAL = new TestimonialsBAL();
    ...
    private void BindList()
    {
        ...
        objTestimonialsBAL.Title = Title;
        dt = objTestimonialsBAL.GetList(ref CurrentPage, RecordPerPage, out TotalRecord, SortColumn, SortType);
    ...
    private void Operation()
    {
        ...
        {
            ObjTestimonialsBAL.TestimonialsOperation(Convert.ToString(Request["ID"]), ObjOpr);
            Response.Write(Javascript.DisplayMsg(divMsg.ClientID, strMsg, Javascript.MessageType.Success, true));
        }
        else
        {
            ObjTestimonialsBAL.TestimonialsOperation(Convert.ToString(Request["hdnID"]), ObjOpr);
