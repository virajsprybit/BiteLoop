<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="restaurant-types-list.aspx.cs" Inherits="AdminPanel_RestaurantTypes_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHContent" runat="Server">
    <div class="row add-padding">
        <div class="pull-left">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="javascript:;" class="text-transparent" id="lnkSubmenu" runat="server">Restaurant Type List</a></li>
            </ol>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="panel panel-default">
            ...
            <div class="panel-body panel-collapse collapse collapse" id="collapseThree">
                <form id="frmSearch" onsubmit="SubmitForm();return false;" action="restaurant-types-list.aspx">
    ...
    <div class="panel">
        <div class="panel-heading">
            <div class="pull-left">
                <h4><i class="icon-table"></i>Restaurant Type List</h4>
            </div>
            <div class="pull-right padding-right"><a class="btn btn-info" href="restaurant-types-modify.aspx">Add New</a></div>
            <div class="clearfix"></div>
        </div>
                                    ...
                                    <asp:Repeater runat="server" ID="rptRecord">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="text-primary"><strong><%# Eval("Name") %></strong></span>
                                                </td>

                                                <%--<td style="text-align: center">
                                                    <%# 
                                                       !string.IsNullOrEmpty(Convert.ToString(Eval("IconUrl"))) 
                                                       ? "<img src='" + ResolveUrl("~/uploads/category/" + Eval("IconUrl")) + "' width='40' height='40' style='border-radius:5px;' />" 
                                                       : "-"
                                                    %>
                                                </td>--%>

                                                <%--<td><span class="text-primary"><strong><%#((System.Data.DataRowView)Container.DataItem)["Name"]%></strong></span> </td>--%>
                                                <td class="actions">
                                                ...
                                                <td class="actions">
                                                    <a href="restaurant-types-modify.aspx?id=<%# ((System.Data.DataRowView) Container.DataItem)["ID"] %>" title="Edit"><i class="icon-pencil"></i></a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHFooter" runat="Server">
    <script type="text/javascript">
        ...
        var PageUrl = 'restaurant-types-list.aspx';
