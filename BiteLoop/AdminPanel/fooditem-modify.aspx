<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="fooditem-modify.aspx.cs" Inherits="AdminPanel_FoodItems_Modify" EnableEventValidation="false" ValidateRequest="false" %>
    ...
    <div class="row add-padding">
        <div class="pull-left">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="javascript:;" class="text-transparent" id="lnkSubmenu" runat="server">Food Item Modify</a></li>
            </ol>
        </div>
    </div>
    <!-- row 2 -->
        ...
        <div class="col-lg-12">
            <div class="panel">
                <div class="panel-body well-lg">
                    <form id="frmFoodItems" action="fooditem-modify.aspx?id=<%=ID%>" method="post" target="ifrmForm" enctype="multipart/form-data" onsubmit="return ValidateForm(this);">
                        ...
                        <div class="pull-right">
                            ...
                            <button type="button" class="btn btn-default" onclick="window.location='fooditems-list.aspx';">Cancel</button>
                        </div>
