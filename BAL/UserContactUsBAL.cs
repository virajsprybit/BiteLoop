namespace BAL
{
    ...
    public class UserContactUsBAL : UserContactUsPAL
    {
        /// <summary>
        /// Get Contact Us Details by ID
        /// </summary>
        /// <returns></returns>
        public DataTable GetUserContactUsByID()
        {
            DbParameter[] dbParam = new DbParameter[] { new DbParameter("@ID", DbParameter.DbType.Int, 20, base.ID) };
            DataTable table = new DataTable();
            return DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "UserContactUsByID", dbParam);
        }
        ...
        public DataTable GetList(ref int intCurrentPage, int intRecordPerPage, out int intTotalRecord, string strSortColumn, string strSortType)
        {
            ...
            if ((strSortColumn != string.Empty) && (strSortType != string.Empty))
            {
                ...
                dbParam[8] = new DbParameter("@SortColumn", DbParameter.DbType.VarChar, 45, strSortColumn);
            }
            DataTable table = new DataTable();
            table = DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "UserContactUsList", dbParam);
        ...
        public void Operation(string strConatctID, Common.DataBaseOperation ObjOperation)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "UserContactUsOperation", dbParam);
        }
        ...
        public long Save()
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "UserContactUsSave", dbParam);
