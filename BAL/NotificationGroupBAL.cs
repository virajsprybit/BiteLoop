namespace BAL
{
    ...
    public class NotificationGroupBAL : NotificationGroupPAL
    {
        /// <summary>
        ...
        public DataTable GetByID()
        {
            ...
            return DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "NotificationGroupByID", dbParam);
        }
        public DataTable GetList(ref int intCurrentPage, int intRecordPerPage, out int intTotalRecord, string strSortColumn, string strSortType)
        {
            ...
            DataTable table = new DataTable();
            table = DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "NotificationGroupList", dbParam);
        ...
        public void Operation(string strConatctID, Common.DataBaseOperation ObjOperation)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "NotificationGroupOperation", dbParam);
        }
        ...
        public long Save()
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "NotificationGroupModify", dbParam);
            return Convert.ToInt64(dbParam[5].Value);
        }
        public DataTable NotificationGroupsListAdmin()
        {
            return DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "NotificationGroupsListAdmin");
        }
    }
}
