namespace BAL
{
    ...
    public class FoodItemsBAL : FoodItemsPAL
    {
        /// <summary>
        /// FoodItems Operations Active/Deactive/Delete
        /// </summary>
        /// <param name="ID"></param>
        /// <param name="ObjOperation"></param>
        public void FoodItemsOperation(string ID, Common.DataBaseOperation ObjOperation)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "FoodItemsOperation", dbParam);
        }
      
        /// <summary>
        /// Get FoodItems Details By ID
        /// </summary>
        /// <returns></returns>
        public DataTable GetFoodItemsByID()
        {
            DbParameter[] dbParam = new DbParameter[] { new DbParameter("@ID", DbParameter.DbType.Int, 20, base.ID) };
            DataTable table = new DataTable();
            return DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "FoodItemsList", dbParam);
        }
        ...
        public DataTable GetList(ref int CurrentPage, int RecordPerPage, out int TotalRecord, string SortColumn, string SortType)
        {
            ...
            DataTable table = new DataTable();
            table = DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "FoodItemsList", dbParam);
        ...
        public int Save()
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "FoodItemsModify", dbParam);
